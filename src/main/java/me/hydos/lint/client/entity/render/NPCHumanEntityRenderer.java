...
public class NPCHumanEntityRenderer extends PlayerEntityRenderer {
	public NPCHumanEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
		super(entityRenderDispatcher);
	}

	@Override
	public Identifier getTexture(AbstractClientPlayerEntity abstractClientPlayerEntity) { // TODO override this
