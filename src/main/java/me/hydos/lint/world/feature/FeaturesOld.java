...
public class FeaturesOld {
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> FROZEN_TREE = register("frozen_tree", LINT_TREE.configure(
			new TreeFeatureConfig.Builder(
					...
					new SimpleBlockStateProvider(LintBlocks.FROZEN_SAPLING.getDefaultState()),
	...
	public static final ConfiguredFeature<?, ?> FROSTED_TUSSOCKS = registerPatch("frosted_tussocks", Configs.FROSTED_TUSSOCK_CONFIG, 2);
	public static final ConfiguredFeature<?, ?> MISTBLOOMS = registerPatch("mistbloom", Configs.MISTBLOOM, 1);
	public static final ConfiguredFeature<?, ?> FROZEN_STEMS = registerPatch("frozen_stems", Configs.FROZEN_STEM, 1);
	public static final ConfiguredFeature<?, ?> SAKHALIN_MINTS = registerPatch("sakhalin_mint", Configs.SAKHALIN_MINT, 2);
	public static final ConfiguredFeature<?, ?> MARIGOLDS = registerPatch("marigold", Configs.MARIGOLD, 1);
	...
	public static final ConfiguredFeature<?, ?> LESS_SPEARMINTS = registerChancePatch("less_spearmints", Configs.SPEARMINT_CONFIG, 1);
	...
	public static final ConfiguredFeature<?, ?> LESS_DILLS = registerChancePatch("less_dills", Configs.DILL_CONFIG, 1);
	...
	public static final class Configs {
		...
		public static final RandomPatchFeatureConfig MISTBLOOM = new RandomPatchFeatureConfig.Builder(
				new SimpleBlockStateProvider(LintBlocks.MISTBLOOM.getDefaultState()),
				SimpleBlockPlacer.INSTANCE)
				.tries(4).build();

		public static final RandomPatchFeatureConfig FROZEN_STEM = new RandomPatchFeatureConfig.Builder(
				new SimpleBlockStateProvider(LintBlocks.FROZEN_STEM.getDefaultState()),
				SimpleBlockPlacer.INSTANCE)
				.tries(8).build();

		public static final RandomPatchFeatureConfig MARIGOLD = new RandomPatchFeatureConfig.Builder(
				new SimpleBlockStateProvider(LintBlocks.MARIGOLD.getDefaultState()),
				SimpleBlockPlacer.INSTANCE)
				.tries(4).build();
