...
public class Biomes {
	...
	public static final SpawnSettings.Builder OCEAN_SPAWN_SETTINGS = new SpawnSettings.Builder()
			.spawn(SpawnGroup.WATER_CREATURE, new SpawnSettings.SpawnEntry(EntityType.SQUID, 1, 1, 4))
			.spawn(SpawnGroup.WATER_AMBIENT, new SpawnSettings.SpawnEntry(EntityType.COD, 10, 3, 6))
			.spawn(SpawnGroup.WATER_AMBIENT, new SpawnSettings.SpawnEntry(EntityType.PUFFERFISH, 5, 1, 3))
	...
	public static final RegistryKey<Biome> FROZEN_OCEAN_KEY = RegistryKey.of(Registry.BIOME_KEY, Lint.id("frozen_ocean"));
	...
	public static final Biome MYSTICAL_GROVE = new Biome.Builder()
			...
			.generationSettings(new GenerationSettings.Builder()
					...
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.SICIERON_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.JUREL_ORE)
	...
	public static final Biome MYSTICAL_FOREST = new Biome.Builder()
			...
			.generationSettings(new GenerationSettings.Builder()
					...
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.SPEARMINTS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.WATERMINTS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.TUSSOCKS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.RED_TUSSOCKS)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.TARSCAN_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.SICIERON_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.JUREL_ORE)
					.feature(GenerationStep.Feature.TOP_LAYER_MODIFICATION, ConfiguredFeatures.FREEZE_TOP_LAYER)
	...
	public static final Biome ETHEREAL_WOODLAND = new Biome.Builder()
			...
			.generationSettings(new GenerationSettings.Builder()
					...
					.feature(GenerationStep.Feature.SURFACE_STRUCTURES, FeaturesOld.CONFIGURED_RETURN_PORTAL)
					.feature(GenerationStep.Feature.SURFACE_STRUCTURES, FeaturesOld.CONFIGURED_TOWN)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.FROZEN_TREES)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.MARIGOLDS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.FROSTED_TUSSOCKS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.MISTBLOOMS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.FROZEN_STEMS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.SAKHALIN_MINTS)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.TARSCAN_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.SICIERON_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.JUREL_ORE)
					.feature(GenerationStep.Feature.TOP_LAYER_MODIFICATION, ConfiguredFeatures.FREEZE_TOP_LAYER)
	...
	public static final Biome CORRUPT_FOREST = new Biome.Builder()
			...
			.generationSettings(new GenerationSettings.Builder()
					...
					.feature(GenerationStep.Feature.SURFACE_STRUCTURES, FeaturesOld.CONFIGURED_RETURN_PORTAL)
					.feature(GenerationStep.Feature.SURFACE_STRUCTURES, FeaturesOld.CONFIGURED_TOWN)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.CORRUPT_TREES)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.CORRUPT_STEMS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.WILTED_FLOWERS)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, FeaturesOld.KUREI)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.TARSCAN_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.SICIERON_ORE)
					.feature(GenerationStep.Feature.UNDERGROUND_ORES, FeaturesOld.JUREL_ORE)
					.feature(GenerationStep.Feature.TOP_LAYER_MODIFICATION, ConfiguredFeatures.FREEZE_TOP_LAYER)
	...
	public static final Biome FROZEN_OCEAN = new Biome.Builder()
			.precipitation(Biome.Precipitation.NONE)
			.category(Biome.Category.OCEAN)
			.depth(-0.5f)
			.scale(1)
