		...
		structures = StructurePools.register(
				new StructurePool(Lint.id("dungeon"), new Identifier("empty"),
						ImmutableList.of(
								...
								Pair.of(Structures.createSinglePoolElement("dungeon/pathway/large_carpet_stairs", StructureProcessorLists.EMPTY), 50),
								Pair.of(Structures.createSinglePoolElement("dungeon/pathway/prison_corner_connector", StructureProcessorLists.EMPTY), 50),
								Pair.of(Structures.createSinglePoolElement("dungeon/pathway/staircase_split_connector_enterance", StructureProcessorLists.EMPTY), 50),
