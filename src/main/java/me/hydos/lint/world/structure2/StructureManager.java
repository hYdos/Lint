...
public class StructureManager {
	public StructureManager() {
		// TODO structure managing shit
	}
	
	private final FIFOCache<LintStructureInstance> activeInstances = new FIFOCache<>(new LintStructureInstance[16]);

	public static void registerStructure(LintStructure structure) {
		STRUCTURES.add(structure);
	}

	private static final List<LintStructure> STRUCTURES = new ArrayList<>();
}
