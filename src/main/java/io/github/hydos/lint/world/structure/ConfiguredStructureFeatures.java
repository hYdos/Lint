...
public interface ConfiguredStructureFeatures {
    ...
    ConfiguredStructureFeature<StructurePoolFeatureConfig, ? extends StructureFeature<StructurePoolFeatureConfig>> DUNGEON = register("village_plains", StructureFeature.VILLAGE.configure(new StructurePoolFeatureConfig(() -> DungeonGenerator.structures, 7)));
